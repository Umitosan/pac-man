...
Pac.prototype.softReset = function() { // reset pac to original valuse
...
Pac.prototype.timedPause = function(dur) {
...
Pac.prototype.tmpUnpause = function() {
  this.timedPauseState = false;
  this.timedPauseDur = 0;
  this.timedPauseBegin = null;
...
Pac.prototype.inBounds = function(tDir) {
  let bounds = 'none';
...
Pac.prototype.changeDir = function(newDir) {
...
Pac.prototype.movePac = function() {
...
Pac.prototype.rotatePacFace = function() {
...
Pac.prototype.hopToIn = function() {
  let spacing = State.gridSpacing;
...
Pac.prototype.tryEatPill = function() {
  let data = getNearestIntersection(this.x,this.y);
...
Pac.prototype.nextMouth = function() {
...
Pac.prototype.nextDeathMouth = function() {
...
Pac.prototype.initDeathSparkles = function() {
...
Pac.prototype.nextDeathSparkle = function() {
...
Pac.prototype.pixTest = function(sDir) {
  var xCoef = 0;
  var yCoef = 0;
  if ( sDir === 'left' ) {
    xCoef = -1;
...
Pac.prototype.drawPixTestBox = function() {
  let ctx = State.ctx;
  ctx.beginPath();
